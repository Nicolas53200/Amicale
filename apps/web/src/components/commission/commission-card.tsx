      ...
      <div className="flex shrink-0 items-center gap-1 pt-1.5">
        ...
        {onDelete && !isFixed && (
          <button
            ...
            className="flex h-8 w-8 items-center justify-center rounded-full text-content-muted transition-colors hover:bg-red-50 hover:text-red-500 dark:hover:bg-red-500/10"
            title="Supprimer"
          >
