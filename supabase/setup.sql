...
INSERT INTO events (id, org_id, commission_id, title, description, date, end_date, location, max_attendees, price, max_benevoles, category) VALUES
  ('e0000001-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', 'c0000001-0000-0000-0000-000000000001', 'Repas de l''amicale', 'Grand repas annuel de l''amicale. Menu : apéritif, entrée, plat, dessert, vin compris. Soirée dansante à partir de 22h.', '2026-09-20 19:00:00+02', '2026-09-21 02:00:00+02', 'Salle des fêtes de Laval', 120, 25, 8, 'repas'),
  ('e0000002-0000-0000-0000-000000000002', '11111111-1111-1111-1111-111111111111', 'c0000001-0000-0000-0000-000000000001', 'Tournoi de foot inter-centres', 'Tournoi de football entre les différents centres de secours du département. Équipes de 6 joueurs.', '2026-08-16 09:00:00+02', '2026-08-16 18:00:00+02', 'Stade municipal', 60, 0, 6, 'sport'),
  ('e0000003-0000-0000-0000-000000000003', '11111111-1111-1111-1111-111111111111', 'c0000007-0000-0000-0000-000000000007', 'Sainte-Barbe 2026', 'Cérémonie de la Sainte-Barbe suivie du repas traditionnel. Tenue de cérémonie obligatoire.', '2026-12-04 18:00:00+01', '2026-12-05 01:00:00+01', 'Centre de secours Laval', 200, 35, 12, 'ceremonie'),
  ('e0000004-0000-0000-0000-000000000004', '11111111-1111-1111-1111-111111111111', 'c0000005-0000-0000-0000-000000000005', 'Arbre de Noël', 'Fête de Noël pour les enfants des sapeurs-pompiers. Spectacle, goûter et cadeaux.', '2026-12-13 14:00:00+01', '2026-12-13 18:00:00+01', 'Salle du foyer', 80, 0, 10, 'famille'),
  ('e0000005-0000-0000-0000-000000000005', '11111111-1111-1111-1111-111111111111', 'c0000004-0000-0000-0000-000000000004', 'Randonnée VTT', 'Sortie VTT ouverte à tous les niveaux. Parcours de 35 km. Pique-nique tiré du sac.', '2026-07-26 08:30:00+02', '2026-07-26 16:00:00+02', 'Départ parking CIS Laval', 30, 0, 0, 'sport');
...
INSERT INTO trips (id, org_id, commission_id, destination, description, start_date, end_date, price_adult, price_child, max_seats, included, itinerary) VALUES
  ('d0000001-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', 'c0000002-0000-0000-0000-000000000002', 'Saint-Malo', 'Week-end découverte de la cité corsaire. Visite des remparts, de l''aquarium et balade en bateau.', '2026-09-05 07:00:00+02', '2026-09-07 20:00:00+02', 180, 90, 50, '["Transport en bus","Hôtel 2 nuits","Petit-déjeuner","Entrée aquarium"]'::jsonb, '[{"jour":1,"titre":"Arrivée & remparts","desc":"Départ 7h, arrivée 12h. Pique-nique puis visite des remparts."},{"jour":2,"titre":"Aquarium & plage","desc":"Visite de l''aquarium le matin, plage et temps libre l''après-midi."},{"jour":3,"titre":"Balade en mer & retour","desc":"Balade en bateau le matin, retour prévu vers 20h."}]'::jsonb),
  ('d0000002-0000-0000-0000-000000000002', '11111111-1111-1111-1111-111111111111', 'c0000002-0000-0000-0000-000000000002', 'Strasbourg - Marché de Noël', 'Séjour au cœur des marchés de Noël de Strasbourg. Vin chaud et ambiance féérique.', '2026-12-19 06:00:00+01', '2026-12-21 22:00:00+01', 220, 110, 45, '["Transport en bus","Hôtel 2 nuits","Petit-déjeuner","Visite guidée"]'::jsonb, '[{"jour":1,"titre":"Arrivée & marché","desc":"Arrivée en fin de matinée, installation et premier marché."},{"jour":2,"titre":"Visite guidée","desc":"Visite guidée de la vieille ville et de la cathédrale, marchés de Noël."},{"jour":3,"titre":"Temps libre & retour","desc":"Matinée libre pour les derniers achats, retour l''après-midi."}]'::jsonb);
...
INSERT INTO assets (id, org_id, name, type, description, daily_rate, deposit, rules) VALUES
  ('a0000001-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', 'Appartement Sables d''Olonne', 'appartement', 'T3 en front de mer, 6 couchages. Vue mer depuis le balcon. Parking privé.', 65, 300, 'Arrivée après 16h, départ avant 10h. Ménage à faire avant le départ. Animaux non admis. Caution restituée sous 15 jours.'),
  ('a0000002-0000-0000-0000-000000000002', '11111111-1111-1111-1111-111111111111', 'Barnum 6x12m', 'barnum', 'Grande tente barnum 6x12 mètres avec parois amovibles. Idéal pour événements jusqu''à 80 personnes.', 50, 200, 'Récupération au centre. Montage et démontage à votre charge. Nettoyage avant restitution.'),
  ('a0000003-0000-0000-0000-000000000003', '11111111-1111-1111-1111-111111111111', 'Remorque frigorifique', 'remorque', 'Remorque réfrigérée 3m³. Permis B suffisant. Parfaite pour événements.', 35, 150, 'Permis B obligatoire. Récupération au centre. Restitution propre et carburant plein.'),
  ('a0000004-0000-0000-0000-000000000004', '11111111-1111-1111-1111-111111111111', 'Emplacement camping Vendée', 'camping', 'Emplacement dans camping 4 étoiles en Vendée. Accès piscine et animations inclus.', 25, 100, 'Réservation minimum 7 nuits en juillet-août. Arrivée samedi, départ samedi.');
